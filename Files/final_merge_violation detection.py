...
cap = cv2.VideoCapture(r"C:\Users\tutse\Downloads\Drivers caught on camera while crossing red signals.mp4")
...
while True:
    ...
    car_cascade = cv2.CascadeClassifier("E:\Traffic-Signal-Violation-Detection-System-main\Traffic-Signal-Violation-Detection-System-main\cars.xml")
